...
//			'user_website',
	...
	function authenticate()
	{
		...
		\Rhymix\Modules\Sociallogin\Base::setDriverAuthData('facebook', 'token', $accessValue);
	...
	function getSNSUserInfo()
	{
		...
		\Rhymix\Modules\Sociallogin\Base::setDriverAuthData('facebook', 'profile', $profileValue);
