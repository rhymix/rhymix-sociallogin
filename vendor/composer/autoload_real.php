...
class ComposerAutoloaderInite1ee8013aef2ef31ef04bc721a65b6cb
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInite1ee8013aef2ef31ef04bc721a65b6cb::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequiree1ee8013aef2ef31ef04bc721a65b6cb($fileIdentifier, $file);
        }
...
function composerRequiree1ee8013aef2ef31ef04bc721a65b6cb($fileIdentifier, $file)
{
